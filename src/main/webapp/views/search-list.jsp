                            ...
                            <div class="tab-pane fade show active" id="grid-view" role="tabpanel"
                                ...
                                <div class="product-grid-view row">
                                    <%
                                        ...
                                        List<Product> productList = (List<Product>) session.getAttribute("search-result");
                                        String keyword = (String) session.getAttribute("search-key");
                                    %>
                                    <%--Liệt kê sản phẩm--%>
                                    <%
                                            ...
                                            <div class="product-img img-zoom-effect">
                                                <a href="product-detail.jsp?product_id=<%=product.getId()%>">
                                                    ...
                                                    <div class="product-add-action">
                                                        <ul>
                                                            <li>
                                                                <a href="${pageContext.request.contextPath}/Cart?command=addCart&product_id=<%=product.getId()%>">
                                    ...
                                    <%
                                            ...
                                            %>
                                    <div>No product whose name contains "<%=keyword%>"</div>
                                            <%
                                        }
                                    %>
                                </div>
