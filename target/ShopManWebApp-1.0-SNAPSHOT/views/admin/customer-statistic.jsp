<%@ page import="com.example.ShopManWebApp.model.CustomerStat" %>
  ...
  <div class="layout">
    ...
    <div class="page-container">
      ...
      <div class="main-content">
        <div class="page-header">
          ...
          <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
              ...
              <a class="breadcrumb-item" href="#">Customer Statistics</a>
            </nav>
          </div>
        </div>
        <div class="card">
          <div class="card-body">
            <div class="row m-b-30">
              <form method="post" action="${pageContext.request.contextPath}/CustomerStat">
                <div class="col-lg-8">
                  <div class="d-md-flex">
        ...
        <%
          List<CustomerStat> listStat = (List<CustomerStat>) session.getAttribute("customer-stat");
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <h6 class="m-b-0 m-l-10"><%=i.getCusName()%></h6>
                    </div>
                  </td>
                  <td><%=i.getOrder_time()%></td>
                  <td><%=decimalFormat.format(i.getRevenue())%></td>
                  <td class="text-right">
                    <a href="customer-statistic-detail.jsp?cus_id=<%=i.getId()%>" class="btn btn-icon btn-hover btn-sm btn-rounded pull-right">
